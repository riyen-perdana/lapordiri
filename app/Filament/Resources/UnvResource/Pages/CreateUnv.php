...
class CreateUnv extends CreateRecord
{
    protected static string $resource = UnvResource::class;
    protected static ?string $breadcrumb = 'Tambah Universitas';
    protected static ?string $title = 'Tambah Universitas';
    ...
    protected function getCreatedNotification(): ?Notification
    {
        return Notification::make()
            ->success()
            ->title('Sukses')
            ->body('Data Universitas Berhasil Ditambahkan');
    }
