...
class CreateAgm extends CreateRecord
{
    protected static string $resource = AgmResource::class;
    protected static ?string $breadcrumb = 'Tambah Agama';
    protected static ?string $title = 'Tambah Agama';
    ...
    protected function getCreatedNotification(): ?Notification
    {
        return Notification::make()
            ->success()
            ->title('Sukses')
            ->body('Data Agama Berhasil Ditambahkan');
    }
