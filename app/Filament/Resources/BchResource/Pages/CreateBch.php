...
class CreateBch extends CreateRecord
{
    protected static string $resource = BchResource::class;
    protected static ?string $breadcrumb = 'Tambah Kelompok';
    protected static ?string $title = 'Tambah Kelompok';
    ...
    protected function getCreatedNotification(): ?Notification
    {
        return Notification::make()
            ->success()
            ->title('Sukses')
            ->body('Data Kelompok Berhasil Ditambahkan');
    }
