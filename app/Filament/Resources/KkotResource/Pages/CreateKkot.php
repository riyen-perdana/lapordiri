...
class CreateKkot extends CreateRecord
{
    protected static string $resource = KkotResource::class;
    protected static ?string $breadcrumb = 'Tambah Kabupaten-Kota';
    protected static ?string $title = 'Tambah Kabupaten-Kota';
    ...
    protected function getCreatedNotification(): ?Notification
    {
        return Notification::make()
            ->success()
            ->title('Sukses')
            ->body('Data Kabupaten-Kota Berhasil Ditambahkan');
    }
