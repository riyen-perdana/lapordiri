...
class CreateJlp extends CreateRecord
{
    protected static string $resource = JlpResource::class;
    protected static ?string $breadcrumb = 'Tambah Jalur Penerimaan';
    protected static ?string $title = 'Tambah Jalur Penerimaan';
    ...
    protected function getCreatedNotification(): ?Notification
    {
        return Notification::make()
            ->success()
            ->title('Sukses')
            ->body('Data Jalur Penerimaan Berhasil Ditambahkan');
    }
